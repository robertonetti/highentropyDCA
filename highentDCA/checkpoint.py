...
class DecCheckpoint(Checkpoint):
    def __init__(
        ...
        **kwargs,
        ...
        # Generate geometric checkpoints from 0.9 to 0.01 with 15 steps
        ...
        # template = "{0:<20} {1:<50}\n" 
        # with open(self.file_paths["log"], "a") as f:
        #     f.write(template.format("checkpoint densities:",  str(self.checkpt_steps)))
    ...
    def check(
        ...
        **kwargs,
        ...
        Args:
            density (float): Current density of the model.
